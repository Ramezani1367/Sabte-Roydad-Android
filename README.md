...
| `.github/workflows/build-apk.yml` | جریان کاری ساخت APK |
| `.github/workflows/deploy-pages.yml` | انتشار نسخهٔ وب روی GitHub Pages (اختیاری) |
...
2. جریان **Build APK** را می‌بینید که اجرا شده (یا از دکمهٔ **Run workflow** دستی اجرا کنید).
...
جریان **Deploy Pages** پوشهٔ `www` را روی GitHub Pages منتشر می‌کند:
